...
const std::vector<ReclistInfo> &getReclists()
{
    ...
    static const std::vector<ReclistInfo> reclists = {
        ...
        {2, u8"JP - 巽式日本語 CVVC",          82,  6, u8"巽",                 true,
         BinaryDataReclists::cvvc_6mora_txt,        BinaryDataReclists::cvvc_6mora_txtSize,
         BinaryDataReclists::cvvc_6mora_comment_txt, BinaryDataReclists::cvvc_6mora_comment_txtSize},
        {3, u8"JP - 巽式日本語 CVVC (lite)",   46,  6, u8"巽",                 true,
         BinaryDataReclists::cvvc_6mora_lite_txt,   BinaryDataReclists::cvvc_6mora_lite_txtSize,
         BinaryDataReclists::cvvc_6mora_lite_comment_txt, BinaryDataReclists::cvvc_6mora_lite_comment_txtSize},
